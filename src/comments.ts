...
export const SorryAbandoned = (user: string) => ({
    tag: "abandon-sorry",
    status: `@${user} To keep things tidy, we have to close PRs that aren't mergeable but don't have activity in the last month. No worries, though - please open a new PR if you'd like to continue with this change. Thank you!`
});
